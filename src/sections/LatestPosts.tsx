...
export const LatestPosts = (props: {
    ...
    return(
        ...
        <div className="container">
            ...
            <p className="text-xl lg:text-2xl text-center mt-8 text-zinc-400">
                Keep up with the newests trends, updates, and insights in the blockchain world, updated weekly.
            </p>
            </div>
            <div className="mt-16 md:mt-28 grid grid-cols-1 md:grid-cols-2 gap-8" ref={targetRef}>
            ...
            <div className="flex justify-center mt-48 md:mt-32">
                <CutCornerButton>Reag the Blog</CutCornerButton>
            </div>
        </div>
        </section>
    );
