...
const listItems = [
    'Experience unparallelde security and scalability',
...
export const FeaturesGrid = () => {
  ...
  const { scrollYProgress: torrusKnotScrollYProgress } = useScroll({
    target:torusKnotRef,
    offset: ["start end", "end start"],
  });
  const torusKnotTranslateY = useTransform(torrusKnotScrollYProgress, [0,1],[100, -100]);
  const torusKnotRotate = useTransform( torrusKnotScrollYProgress,[0,1],[30, -30]);
            ...
            <div className="container">
              ...
              <h2 className="font-heading font-black text-4xl md:text-5xl lg:text-6xl">Blockforge leads the way.</h2>
               <div className="flex flex-col text-xl lg:text-2xl text-zinc-400 mt-6 gap-6">
                <p>Blockforge is dedicated to supporting the evolution of web3 Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae, sapiente doloremque ab aspernatur saepe autem?</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci voluptatibus aliquam, aperiam vel similique autem. Atque fugiat consequatur dolores. Labore dolores, iure itaque inventore consequuntur exercitationem? Ipsum totam qui porro sint sequi, dolore natus nihil!</p>
              </div>
              <div className="flex gap-8 mt-12">
                <CutCornerButton>Get Started</CutCornerButton>
                <TextButton>Learn More</TextButton>
